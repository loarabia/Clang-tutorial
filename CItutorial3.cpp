...
int main()
{
    ...
    clang::HeaderSearchOptions *rawHso = new clang::HeaderSearchOptions();
    std::shared_ptr<HeaderSearchOptions> hso(rawHso);
    ...
    hso->AddPath("/usr/include",
                                ...
                                false,
                                false);
    hso->AddPath("/usr/lib/gcc/x86_64-linux-gnu/7/include",
                                clang::frontend::Angled,
                                false,
                                false);
